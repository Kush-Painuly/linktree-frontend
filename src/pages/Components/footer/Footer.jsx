...
import footimage from "../../../assets/leftsidefoot.PNG";
      ...
      <div>
        <div className="bg-white rounded-xl">
          <div className="flex items-center justify-around">
            <div>
              <ul>
                <h4 className="font-medium text-xl py-4">Company</h4>
                <li className="py-1">
                  <Link>The Linktree Blog</Link>
                </li>
                <li className="py-1">
                  <Link>Enginnering Blog</Link>
                </li>
                <li className="py-1">
            ...
            <div>
              <ul>
                <h4 className="font-medium text-xl py-4">Community</h4>
                <li className="py-1">
                  <Link>Linktree for Enterprise</Link>
                </li>
                <li className="py-1">
                  <Link>2023 Creators Report</Link>
                </li>
                <li className="py-1">
                  <Link>2022 Creators Report</Link>
                </li>
                <li className="py-1">
                  <Link>Charities</Link>
                </li>
                ...
                <li className="py-1">
                  <Link>Creator Profile Directory</Link>
                </li>
                <li className="py-1">
            ...
            <div>
              <ul>
                <h4 className="font-medium text-xl py-4">Support</h4>
                <li className="py-1">
                  <Link>Help Topics</Link>
                </li>
                <li className="py-1">
                  <Link>Getting Started</Link>
                </li>
                <li className="py-1">
                  <Link>Linktree Pro</Link>
                </li>
                <li className="py-1">
                  <Link>Features & How-Tos</Link>
                </li>
                <li className="py-1">
                  <Link>FAQs</Link>
                </li>
                <li className="py-1">
                  <Link>Report a Violation</Link>
                </li>
              </ul>
            </div>
            <div>
              <ul>
                <h4 className="font-medium text-xl py-4">Trust & Legal</h4>
                <li className="py-1">
          ...
          <div className="flex items-center justify-around pt-8">
            <div className="flex items-center justify-center gap-4 py-4">
              ...
              <div>
                <Link
                  to="/"
                  className="border border-yellow-400 bg-yellow-400 text-black font-medium hover:bg-gray-500 py-4 px-12 rounded-full"
                >
            ...
            <div>
              <img src={footimage} alt="footer-image" />
            </div>
          </div>
        </div>
        <div className="bg-textcolor mt-8 p-16 flex items-center justify-center rounded-xl">
          <svg
        ...
        <div className="flex items-center justify-center p-12">
          <img src={flags} alt="flags-image" />
        </div>
        <div className="text-center">
          <p className="text-textcolor font-medium text-xl">
            We acknowledge the Traditional Custodians of the land on which our
            office stands, The Wurundjeri people of the Kulin <br /> Nation, and pay
            our respects to Elders past, present and emerging. Linktree Pty Ltd
            (ABN 68 608 721 562), 1-9 Sackville <br /> st, Collingwood VIC 3066
          </p>
        </div>
      </div>
    </>
